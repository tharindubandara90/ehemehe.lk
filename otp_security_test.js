...
(async () => {
  ...
  delete require.cache[require.resolve('./api-handlers/request-registration-otp')];
  ...
  const requestHandler = require('./api-handlers/request-registration-otp');
  ...
  delete require.cache[require.resolve('./api-handlers/verify-registration-otp')];
  let createCount = 0;
  global.fetch = async (url, options={}) => {
  ...
  const verifyHandler = require('./api-handlers/verify-registration-otp');
