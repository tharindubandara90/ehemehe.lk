  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:767px){
        ...
        .ehm-pill{height:44px!important;border:2px solid #d4dce5!important;border-radius:999px!important;background:#fff!important;color:#1f2937!important;display:grid!important;grid-template-columns:minmax(0,max-content) clamp(14px,3.8vw,16px)!important;align-items:center!important;justify-content:center!important;column-gap:clamp(5px,1.8vw,7px)!important;min-width:0!important;padding:0 clamp(8px,3vw,12px)!important;font-size:clamp(12.5px,3.7vw,14.5px)!important;font-weight:750!important;letter-spacing:-.01em!important;line-height:1.3!important;box-shadow:0 1px 5px rgba(15,23,42,.04)!important;}
        .ehm-pill span{display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;min-width:0!important;max-width:100%!important;min-height:1.35em!important;padding-block:.08em!important;text-align:center!important;line-height:1.25!important;}
        ...
        @media(max-width:390px){.ehm-mobile-filterbar{gap:7px!important;padding-left:10px!important;padding-right:10px!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr) 42px!important;}.ehm-pill{height:42px!important;padding-inline:clamp(7px,2.5vw,9px)!important;column-gap:clamp(4px,1.5vw,5px)!important;grid-template-columns:minmax(0,max-content) 14px!important;}.ehm-pill b{width:14px!important;min-width:14px!important;}.ehm-pill b svg{width:14px!important;height:14px!important;}.ehm-view-toggle{height:42px!important;width:42px!important;min-width:42px!important;}}
        @media(max-width:340px){.ehm-mobile-filterbar{gap:6px!important;padding-left:8px!important;padding-right:8px!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr) 40px!important;}.ehm-pill{height:40px!important;font-size:12px!important;padding-inline:6px!important;column-gap:4px!important;grid-template-columns:minmax(0,max-content) 13px!important;}.ehm-pill b{width:13px!important;min-width:13px!important;height:13px!important;}.ehm-pill b svg{width:13px!important;height:13px!important;}.ehm-view-toggle{height:40px!important;width:40px!important;min-width:40px!important;}}
